...
STACK_CATALOG: dict[str, list[dict]] = {
    ...
    "automation": [
        {"slug": "n8n",          "name": "n8n",          "tier": "free", "monthly_cost_usd": 0, "category": "automation", "github_url": "https://github.com/n8n-io/n8n",              "stars": 182000, "description": "Visual drag-and-drop workflow automation. 400+ integrations, AI nodes, self-hostable. Best Zapier alternative."},
        {"slug": "dify",         "name": "Dify",         "tier": "free", "monthly_cost_usd": 0, "category": "automation", "github_url": "https://github.com/langgenius/dify",          "stars": 135000, "description": "No-code LLM app and agent builder. RAG, visual workflow, prompt IDE. Production-ready."},
        {"slug": "activepieces", "name": "Activepieces", "tier": "free", "monthly_cost_usd": 0, "category": "automation", "github_url": "https://github.com/activepieces/activepieces", "stars": 21500,  "description": "400+ MCP servers + AI workflow automation. Self-hostable TypeScript."},
        {"slug": "automatisch",  "name": "Automatisch",  "tier": "free", "monthly_cost_usd": 0, "category": "automation", "github_url": "https://github.com/automatisch/automatisch",  "stars": 13700,  "description": "Clean open-source Zapier alternative. Trigger-action automation, no AI bloat."},
    ],

    # ── No-Code App Builders ──────────────────────────────────────────────────
    "no-code-builder": [
        {"slug": "budibase",    "name": "Budibase",    "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/Budibase/budibase",        "stars": 27800, "description": "No-code internal app builder with AI agents and automations. Open-source Retool."},
        {"slug": "coze-studio", "name": "Coze Studio", "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/coze-dev/coze-studio",     "stars": 20400, "description": "ByteDance's visual AI agent IDE. Build, debug and deploy agents — no code needed."},
        {"slug": "fastgpt",     "name": "FastGPT",     "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/labring/FastGPT",          "stars": 27600, "description": "No-code knowledge base + agent workflow builder. MCP support built-in."},
        {"slug": "pyspur",      "name": "PySpur",      "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/PySpur-Dev/pyspur",        "stars": 5700,  "description": "Visual playground for agentic workflows. Iterate 10x faster with live feedback."},
        {"slug": "baserow",     "name": "Baserow",     "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/baserow/baserow",          "stars": 4500,  "description": "No-code Airtable alternative with database, automations, and AI agents."},
        {"slug": "maxun",       "name": "Maxun",       "tier": "free", "monthly_cost_usd": 0, "category": "no-code-builder", "github_url": "https://github.com/getmaxun/maxun",           "stars": 15300, "description": "No-code web scraping and AI data extraction. Point-and-click scraper builder."},
    ],

    # ── AI Agent Frameworks ───────────────────────────────────────────────────
    "agent-framework": [
        {"slug": "crewai",      "name": "CrewAI",      "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/crewAIInc/crewAI",           "stars": 47900, "description": "Most popular agent framework. Role-playing autonomous agents with collaborative intelligence."},
        {"slug": "sim",         "name": "Sim Studio",  "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/simstudioai/sim",            "stars": 27400, "description": "Visual canvas to build, deploy, and orchestrate AI agent workforces."},
        {"slug": "agentgpt",    "name": "AgentGPT",    "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/reworkd/AgentGPT",           "stars": 35900, "description": "Assemble and deploy autonomous AI agents in the browser. No setup needed."},
        {"slug": "haystack",    "name": "Haystack",    "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/deepset-ai/haystack",        "stars": 24700, "description": "Production-ready LLM orchestration framework for RAG, agents, and pipelines."},
        {"slug": "skyvern",     "name": "Skyvern",     "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/Skyvern-AI/skyvern",         "stars": 21000, "description": "AI browser automation. Automate any web workflow with vision + LLMs."},
        {"slug": "superagi",    "name": "SuperAGI",    "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/TransformerOptimus/SuperAGI", "stars": 17400, "description": "Dev-first autonomous AI agent framework. Build, manage, and run production agents."},
        {"slug": "trigger-dev", "name": "Trigger.dev", "tier": "freemium", "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/triggerdotdev/trigger.dev",  "stars": 14300, "description": "Build and deploy fully-managed AI agents and background jobs. Cloud or self-hosted."},
        {"slug": "agent-squad", "name": "Agent Squad", "tier": "free",     "monthly_cost_usd": 0, "category": "agent-framework", "github_url": "https://github.com/awslabs/agent-squad",        "stars": 7600,  "description": "AWS open-source framework for multi-agent systems and complex conversations."},
    ],

    # ── MCP Ecosystem ─────────────────────────────────────────────────────────
    "mcp": [
        {"slug": "fastapi-mcp",    "name": "FastAPI MCP",    "tier": "free", "monthly_cost_usd": 0, "category": "mcp", "github_url": "https://github.com/tadata-org/fastapi_mcp",          "stars": 11700, "description": "Expose any FastAPI endpoint as an MCP tool instantly. With auth."},
        {"slug": "mcp-agent",      "name": "MCP Agent",      "tier": "free", "monthly_cost_usd": 0, "category": "mcp", "github_url": "https://github.com/lastmile-ai/mcp-agent",           "stars": 8200,  "description": "Build effective agents using MCP and simple workflow patterns."},
        {"slug": "mcp-go",         "name": "MCP Go",         "tier": "free", "monthly_cost_usd": 0, "category": "mcp", "github_url": "https://github.com/mark3labs/mcp-go",                 "stars": 8500,  "description": "Go SDK for MCP — build high-performance MCP servers in Go."},
        {"slug": "mcp-registry",   "name": "MCP Registry",   "tier": "free", "monthly_cost_usd": 0, "category": "mcp", "github_url": "https://github.com/modelcontextprotocol/registry",    "stars": 6600,  "description": "Official community-driven registry of MCP servers."},
        {"slug": "mcp-playwright", "name": "MCP Playwright", "tier": "free", "monthly_cost_usd": 0, "category": "mcp", "github_url": "https://github.com/executeautomation/mcp-playwright", "stars": 5400,  "description": "Playwright MCP server — give agents full browser automation capabilities."},
    ],
